        ...
        <div class="container-fluid">
            ...
            <div class="card shadow border-secondary">
                <div class="card-body" align="center">
                    ...
                    <h5>
                        <b class="text-primary" data-text>_LAND OF DOWN_</b>
                    </h5>
                    <p>
                        Kami akan memberikan info terbaru, seputar tournament game MOBA, dari DOTA2, Legue Of Legend, Wartcraft, Mobile Legen Bang Bang dll
                    </p>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?= $this->M_dashboard->get_data('dataa')->num_rows(); ?>
                                    </div>
                                </div>
                                <div class="col-auto">
